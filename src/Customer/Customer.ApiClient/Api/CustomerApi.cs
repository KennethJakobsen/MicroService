...
namespace Customer.ApiClient.Api
{
    ...
    public interface ICustomerApiSync : IApiAccessor
    {
        ...
        /// 
        /// </summary>
        /// <exception cref="Customer.ApiClient.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="id"></param>
    ...
    {
        private Customer.ApiClient.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = Customer.ApiClient.Client.Configuration.MergeConfigurations(
                Customer.ApiClient.Client.GlobalConfiguration.Instance,
                new Customer.ApiClient.Client.Configuration { BasePath = basePath }
            );
            this.Client = new Customer.ApiClient.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Customer.ApiClient.Client.ApiClient(this.Configuration.BasePath);
            this.ExceptionFactory = Customer.ApiClient.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public CustomerApi(Customer.ApiClient.Client.Configuration configuration)
        {
            ...
            this.Client = new Customer.ApiClient.Client.ApiClient(this.Configuration.BasePath);
            this.AsynchronousClient = new Customer.ApiClient.Client.ApiClient(this.Configuration.BasePath);
            ExceptionFactory = Customer.ApiClient.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        public CustomerApi(Customer.ApiClient.Client.ISynchronousClient client, Customer.ApiClient.Client.IAsynchronousClient asyncClient, Customer.ApiClient.Client.IReadableConfiguration configuration)
        {
        ...
        /// </summary>
        public Customer.ApiClient.Client.IAsynchronousClient AsynchronousClient { get; set; }

        /// <summary>
        /// The client for accessing this underlying API synchronously.
        /// </summary>
        public Customer.ApiClient.Client.ISynchronousClient Client { get; set; }
        ...
        public Customer.ApiClient.Client.IReadableConfiguration Configuration { get; set; }

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Customer.ApiClient.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
        ...
        {
            Customer.ApiClient.Client.ApiResponse<CustomerModel> localVarResponse = GetCustomerByIdWithHttpInfo(id);
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of CustomerModel</returns>
        public Customer.ApiClient.Client.ApiResponse<CustomerModel> GetCustomerByIdWithHttpInfo(string id, int operationIndex = 0)
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
                throw new Customer.ApiClient.Client.ApiException(400, "Missing required parameter 'id' when calling CustomerApi->GetCustomerById");
            }

            Customer.ApiClient.Client.RequestOptions localVarRequestOptions = new Customer.ApiClient.Client.RequestOptions();
            ...
            var localVarContentType = Customer.ApiClient.Client.ClientUtils.SelectHeaderContentType(_contentTypes);
            if (localVarContentType != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Content-Type", localVarContentType);
            }

            var localVarAccept = Customer.ApiClient.Client.ClientUtils.SelectHeaderAccept(_accepts);
            if (localVarAccept != null)
            {
                localVarRequestOptions.HeaderParameters.Add("Accept", localVarAccept);
            }

            localVarRequestOptions.PathParameters.Add("id", Customer.ApiClient.Client.ClientUtils.ParameterToString(id)); // path parameter
        ...
        {
            Customer.ApiClient.Client.ApiResponse<CustomerModel> localVarResponse = await GetCustomerByIdWithHttpInfoAsync(id, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (CustomerModel)</returns>
        public async System.Threading.Tasks.Task<Customer.ApiClient.Client.ApiResponse<CustomerModel>> GetCustomerByIdWithHttpInfoAsync(string id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'id' is set
            if (id == null)
            {
        ...
        {
            Customer.ApiClient.Client.ApiResponse<List<CustomerModel>> localVarResponse = ListAllCustomersWithHttpInfo();
            return localVarResponse.Data;
        }
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;CustomerModel&gt;</returns>
        public Customer.ApiClient.Client.ApiResponse<List<CustomerModel>> ListAllCustomersWithHttpInfo(int operationIndex = 0)
        {
            Customer.ApiClient.Client.RequestOptions localVarRequestOptions = new Customer.ApiClient.Client.RequestOptions();
        ...
        {
            Customer.ApiClient.Client.ApiResponse<List<CustomerModel>> localVarResponse = await ListAllCustomersWithHttpInfoAsync(operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;CustomerModel&gt;)</returns>
        public async System.Threading.Tasks.Task<Customer.ApiClient.Client.ApiResponse<List<CustomerModel>>> ListAllCustomersWithHttpInfoAsync(int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
